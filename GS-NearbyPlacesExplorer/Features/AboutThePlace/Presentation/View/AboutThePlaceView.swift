...
/// Root SwiftUI view for the AboutThePlace module.
///
...
struct AboutThePlaceView: View {
    ...
    init(viewModel: AboutThePlaceViewModel) {
    ...
    private func contentView(items: [AboutThePlaceModel]) -> some View {
        List(items) { item in
...
#Preview {
    AboutThePlaceView(viewModel: AboutThePlaceViewModel())
}
