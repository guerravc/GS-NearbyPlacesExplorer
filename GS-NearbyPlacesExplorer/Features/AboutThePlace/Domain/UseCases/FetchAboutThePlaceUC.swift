...
/// Async operation Use Case for fetching data of the AboutThePlace module.
///
...
public protocol FetchAboutThePlaceUC: AsyncOperationUseCase
where Output == AboutThePlaceEntity { }

/// Default implementation of `FetchAboutThePlaceUC`.
///
...
public struct FetchAboutThePlaceUCImpl: FetchAboutThePlaceUC {
  ...
  public struct Input: Sendable {
    ...
    public let request: AboutThePlaceRequest
    
    /// Creates a new input instance.
    /// - Parameter request: Request model with the parameters needed by the backend.
    public init(request: AboutThePlaceRequest) {
  ...
  private let gateway: AboutThePlaceGateway
  ...
  public init(gateway: AboutThePlaceGateway) {
