...
/// Async operation Use Case for fetching data of the Login module.
///
...
public protocol FetchLoginUC: AsyncOperationUseCase
where Output == LoginEntity { }

/// Default implementation of `FetchLoginUC`.
///
...
public struct FetchLoginUCImpl: FetchLoginUC {
  ...
  public struct Input: Sendable {
    ...
    public let request: LoginRequest
  ...
  public init(gateway: LoginGateway) {
