...
/// Default local storage implementation for the Login module.
///
...
public final class DefaultLoginStorage: LoginLocalDataSource {
  
  /// Creates a new instance of the storage layer.
  public init() { }
  
  // MARK: - LoginLocalDataSource
  ...
  public func loadCachedEntity() async throws -> LoginEntity? {
