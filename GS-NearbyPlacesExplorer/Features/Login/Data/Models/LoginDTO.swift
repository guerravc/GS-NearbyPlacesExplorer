...
/// for JSON serialization. The domain `LoginEntity` remains
...
nonisolated public struct LoginEntityDTO: Codable, Sendable {
  /// Entity identifier.
  public let id: UUID
  /// Display name.
  ...
  /// Creates a new instance of `LoginEntityDTO`.
  /// - Parameters:
  ...
  public func toDomain() -> LoginEntity {
    LoginEntity(id: id, name: name, detail: detail)
  }
}

/// Data Transfer Object for the response envelope of the Login module.
///
/// This type wraps `LoginEntityDTO` and is decoded directly from
/// the backend JSON. Use `toDomain()` to convert to the domain response.
nonisolated public struct LoginResponseDTO: Codable, Sendable {
  /// The entity DTO as received from the backend.
  public let entity: LoginEntityDTO
  /// Additional numeric value from the backend.
  public let extraValue: Int

  /// Creates a new instance of `LoginResponseDTO`.
  /// - Parameters:
  ///   - entity: The entity DTO from the backend.
  ///   - extraValue: Additional numeric value associated with the response.
  public init(entity: LoginEntityDTO, extraValue: Int) {
    self.entity = entity
