// 
//  NearbyPlacesDataSourceProtocol.swift
...
/// Local data source for the NearbyPlaces module.
///
...
public protocol NearbyPlacesLocalDataSource: Sendable {
  ...
  func loadCachedEntity() async throws -> NearbyPlacesEntity?
