...
/// Data Transfer Object for `NearbyPlacesEntity`.
///
/// This type mirrors the domain entity fields and adds `Codable` conformance
/// for JSON serialization. The domain `NearbyPlacesEntity` remains
...
nonisolated public struct NearbyPlacesEntityDTO: Codable, Sendable {
  /// Entity identifier.
  public let id: UUID
  /// Display name.
  ...
  /// Creates a new instance of `NearbyPlacesEntityDTO`.
  /// - Parameters:
  ...
  public init(entity: NearbyPlacesEntity) {
    self.id = entity.id
  ...
  public func toDomain() -> NearbyPlacesEntity {
    NearbyPlacesEntity(id: id, name: name, detail: detail)
  }
}

/// Data Transfer Object for the response envelope of the NearbyPlaces module.
///
/// This type wraps `NearbyPlacesEntityDTO` and is decoded directly from
/// the backend JSON. Use `toDomain()` to convert to the domain response.
nonisolated public struct NearbyPlacesResponseDTO: Codable, Sendable {
  /// The entity DTO as received from the backend.
  public let entity: NearbyPlacesEntityDTO
  /// Additional numeric value from the backend.
  public let extraValue: Int

  /// Creates a new instance of `NearbyPlacesResponseDTO`.
  /// - Parameters:
  ///   - entity: The entity DTO from the backend.
  ///   - extraValue: Additional numeric value associated with the response.
  public init(entity: NearbyPlacesEntityDTO, extraValue: Int) {
    self.entity = entity
    self.extraValue = extraValue
  }

  /// Maps this DTO to the corresponding domain response.
  public func toDomain() -> NearbyPlacesResponse {
